...
import d__default, { useMemo, useState, useContext, useRef, useEffect } from 'react';

var x=class extends d.Component{constructor(r){super(r),this.state={hasError:!1};}static getDerivedStateFromError(){return {hasError:!0}}componentDidCatch(r,o){console.error("GIF Picker React failed to render:",r,o);}render(){return this.state.hasError?null:this.props.children}};var he=d__default.createContext(null),s=he;var ye=d.createContext(null),p=ye;function a(e,{insertAt:r}={}){if(!e||typeof document>"u")return;let o=document.head||document.getElementsByTagName("head")[0],t=document.createElement("style");t.type="text/css",r==="top"&&o.firstChild?o.insertBefore(t,o.firstChild):o.appendChild(t),t.styleSheet?t.styleSheet.cssText=e:t.appendChild(document.createTextNode(e));}a(`.GifPickerReact .gpr-body{display:flex;flex:1;min-height:0}
`);var xe=d.createContext(null),l=xe;a(`.GifPickerReact .gpr-category-placeholder{border-radius:var(--gpr-category-border-radius);position:relative}
`);a(`.GifPickerReact .gpr-placeholder{background-color:var(--gpr-placeholder-color);transition:opacity .2s ease-in-out}
`);function be(e){return d__default.createElement("div",{...e,className:`gpr-placeholder ${e.className||""}`,style:{width:e.width,height:e.height,...e.style}})}var v=be;function Pe(){let e=useContext(l);return d__default.createElement(v,{className:"gpr-category-placeholder",height:e.categoryHeight,width:"100%"})}var j=Pe;a(`.GifPickerReact .gpr-category-list{display:grid;grid-gap:var(--gpr-category-list-padding);flex:1;grid-auto-rows:min-content;overflow-y:scroll;padding:var(--gpr-body-padding)}
